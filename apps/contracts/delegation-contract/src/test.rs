...
fn create_test_env<'a>() -> (Env, DelegationContractClient<'a>, Address, Address, Address, Address, Address) {
    let env = Env::default();
    let admin = Address::generate(&env);
    let client = DelegationContractClient::new(&env, &env.register(DelegationContract {},(&admin, 1i128)));
