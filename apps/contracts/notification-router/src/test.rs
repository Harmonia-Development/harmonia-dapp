...
use crate::{category, severity, NotificationRouterContract, NotificationRouterContractClient};
use soroban_sdk::{symbol_short, testutils::Events, vec, Env};
...
fn test_invalid_category() {
    ...
    let notifications = vec![
        &env,
        (symbol_short!("test"), symbol_short!("test"), severity::LOW),
    ];
