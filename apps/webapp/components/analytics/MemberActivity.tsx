		...
		return (
			<div className="flex justify-center gap-6 mt-5 text-xs">
				<div className="flex items-center">
					<div className="mr-2 h-3 w-3 rounded-sm bg-[#9333ea]" />
					<span className="text-[#9333ea]">Active Members</span>
				</div>
				<div className="flex items-center">
					<div className="mr-2 h-3 w-3 rounded-sm bg-[#3b82f6]" />
					<span className="text-[#3b82f6]">New Members</span>
				</div>
			</div>
		)
	}, [])
