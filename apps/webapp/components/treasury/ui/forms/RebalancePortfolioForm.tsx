...
import { RebalancePortfolioFormValues } from "../../schema/rebalance-portfolio-modal.schema";
...
export const RebalancePortfolioForm = ({
  onClose,
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex items-center gap-4 pt-2 border-t">
          ...
          <div
            className={`font-medium ${total !== 100 ? "text-destructive" : ""}`}
          >
