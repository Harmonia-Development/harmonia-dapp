...
const DashboardCard: React.FC<DashboardCardProps> = ({
	...
	icon: Icon,
	gradient = { from: 'from-gray-darker', to: 'to-gray-darker' },
	...
	return (
		<div
			className={cn(
				'rounded-lg p-4 md:p-5 lg:p-6 border border-gray-dark hover:border-gray-border transition-all duration-300',
				'w-full max-w-full',
		...
		>
			...
			{completionPercentage !== undefined && (
				<div className="mt-3">
					...
					<div className="w-full bg-gray-dark rounded-full h-1.5 sm:h-2">
						<div
